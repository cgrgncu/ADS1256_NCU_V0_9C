...
+ IAR版本: IAR 8.30.1
> 安裝筆記: 在Win7下，一定要勾選「Dongle Driver」才會順便安裝需要的VC++散發套件。「Debug probe drivers」只勾選有需要的「NU-LINK」。安裝完畢後，再去新增移除程式的地方移除「Dongle Driver」(Sentinel System Driver Installer 7.6.0)。

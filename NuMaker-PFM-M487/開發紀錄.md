...
+ 接著把「\M480BSP-3.05.001\SampleCode\Template\GCC」、「\M480BSP-3.05.001\SampleCode\Template\Keil」資料夾都刪除。
+ 再把「\M480BSP-3.05.001\SampleCode\Template\IAR」資料夾中的「Template.ewd」、「Template.ewp」、「Template.eww」分別改為「LED_example.ewd」、「LED_example.ewp」、「LED_example.eww」。
+ 再將「LED_example.eww」用文字編輯器打開，把「<path>$WS_DIR$\Template.ewp</path>」改成「<path>$WS_DIR$\LED_example.ewp</path>」

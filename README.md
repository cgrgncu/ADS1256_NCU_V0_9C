...
**1. 電源模組 (DC-DC Converter)**

* **RS6-1212D**
    * **數量**：1 個
    * **用途**：為 Bartington 磁力儀提供 ±12V 雙電源。
* **RS6-1205D**
    * **數量**：1 個
    * **用途**：為 INA597 和 ADS1256 提供 ±5V 雙電源。
...
* **INA597** (8 腳 TSSOP 封裝)
  * INA597IDR 
    * **數量**：8 個
    * **用途**：高精度差動放大器，用於放大 Bartington 的訊號。
...
* **陶質電容 (X7R)**
    ...
    * **容值**：1.0µF
    * **電壓**：> 12V
    * **用途**：用於所有高頻濾波和去耦。包括總電源、RS6-1205D 輸出以及 8 個 INA597 晶片。
### 已知問題
+ 手焊零件品質不佳，測試不易。
...
+ SPI路徑上電阻不見了
  ...
  + ADS1256#3:
    + R119、R122、R125、R128、R129
  + ADS1256#4:
    + R150、R151、R152、R153、R154
  + ADS1256#5:
    + R171、R174、R177、R180、R181
  + ADS1256#6:
    + R202、R203、R204、R205、R206
  + ADS1256#7:
    + R223、R226、R229、R232、R233
  + ADS1256#8:
...
+ 其他不見了的電阻
  ...
  + R53
+ 印刷錯誤
  + C49被印刷成C81，導致有兩個C81。在U12與U16附近。
+ 拉線錯誤
  + U24_Pin24未接到AGND
  + C144到U25_Pin3的Trace沒Lay好
  + U18_Pin2未接到AGND
  + U18_Pin3未接到AGND
  + JP4應該lay成2.54mm的Pin header for LCD Panel
  + CM2被錯接到U1_Pin82，正確應該要接到U1_Pin62
  + R5短路，造成LED燒毀。解決方式:POWER1的LED拔掉，R5拔掉。
+ L13~L16電感都要上件
...
+ 儲存裝置:
  ...
  + 檔案系統採用FAT32或exFAT:
    ...
    + 建議每個資料夾內的檔案數量與子資料夾總數不超過2000個(子資料夾內的檔案與資料夾不計)。若一天一個資料夾，三年約1095個資料夾，十年約3650個資料夾。
  + 容量需求:
    + 每分鐘儲存在一個檔案中:
      + 保留1024[Bytes]作為檔頭。 
      + 8[ch]1000[Hz]24[bit]:
